...
import { BillTitleComponent } from './components/bill-title/bill-title.component';
import {
  DropdownEventsOptionsComponent
} from './pages/history/components/dropdown-events-options/dropdown-events-options.component';
